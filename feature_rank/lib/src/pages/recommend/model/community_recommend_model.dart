...
//
//     final CommunityRecommendModel = CommunityRecommendModelFromJson(jsonString);

import 'package:json_annotation/json_annotation.dart';

part 'community_recommend_model.g.dart';

@JsonSerializable()
class CommunityRecommendModel {
  @JsonKey(name: "itemList")
  List<CommunityRecommendModelItemList>? itemList;
  @JsonKey(name: "count")
  int? count;
  @JsonKey(name: "total")
  int? total;
  ...
  factory CommunityRecommendModel.fromJson(Map<String, dynamic> json) => _$CommunityRecommendModelFromJson(json);

  Map<String, dynamic> toJson() => _$CommunityRecommendModelToJson(this);
}

@JsonSerializable()
class CommunityRecommendModelItemList {
  @JsonKey(name: "type")
  String? type;
  @JsonKey(name: "data")
  PurpleData? data;
  ...
  factory CommunityRecommendModelItemList.fromJson(Map<String, dynamic> json) => _$CommunityRecommendModelItemListFromJson(json);

  Map<String, dynamic> toJson() => _$CommunityRecommendModelItemListToJson(this);
}
