import 'package:feature_rank/src/components/attention/community_attention_list_widget.dart';
...
class CommunityAttentionWidget extends StatelessWidget {
  const CommunityAttentionWidget({super.key});
  ...
  Widget _pageWidget(BuildContext context) {
    return EasyRefresh(
      ...
      child: const CommunityAttentionListWidget(),
    );
  }
}
